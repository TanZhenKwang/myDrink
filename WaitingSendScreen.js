...
const WaitingSendScreen = () => {
    const navigation = useNavigation();
    const [selectedLink, setSelectedLink] = useState('WaitingSendScreen');
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>Waiting Send</Text>
            ...
            <View style={styles.borderedContainer}>
                <View style={styles.productDetails}>
                    <Text style={styles.productSending}>Sending</Text>
                </View>
                {/* Thematic Break */}
                ...
                {/* Rate Button */}
                <TouchableOpacity style={styles.rateButton} onPress={navigateToContactUs}>
                    <Icon name="phone" size={20} color="#FFD700" />
                    <Text style={styles.rateButtonText}>Contact</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
...
export default WaitingSendScreen;
